...
module.exports = function serviceSpecsExpand(specs) {
  ...
  Object.keys(feathersSchemas).forEach(schemaName => {
    ...
    // Expand _extensions.add    Object.keys(graphqlExt.add).sort().forEach(field => {
  ...
  inspector('>>> feathersSchemas xref', feathersSchemas)
