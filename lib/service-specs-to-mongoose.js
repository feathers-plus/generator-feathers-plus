...
const typeEquivalence = { // json-schema: mongoose
  ...
  'object': Object,
  'integer': Number,
  'ID': mongoose.Schema.ObjectId, // Our GraphQL custom scalar
};
...
module.exports = function feathersSpecToMongoose(feathersSpec, feathersExtension, depth = 1) {
  // const required = feathersSpec.required || []; // Our Mongoose models contain no verification information
  ...
  Object.keys(properties).forEach(name => {
    ...
    switch (property.type) {
      case 'array':
        ...
        break;
      case 'object':
        mongooseSchema[name] = feathersSpecToMongoose(property, feathersExtension, ++depth);
