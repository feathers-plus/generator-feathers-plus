...
module.exports = function (feathersSchemas, feathersExtensions, specsServices) {
  ...
  const sqlMetadata = {}; // SQL metadata for fields in schemas
      ...
      addedFields.forEach(field => {
        ...
        if (addedField) {
          obj[field] = {
            ...
            resolver: addedField.service.resolver || DEFAULT_GRAPHQL_RESOLVER,
          };
        }
      });
    }
