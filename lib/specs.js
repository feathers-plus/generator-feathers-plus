...
async function setPath (generator1, path) {
  console.log('setPath start');
  if (!generator) { // single initialize in case of composeWith
    console.log('setPath start 2');
    ...
    // Extract custom code
    const xxx = await refreshCodeFragments();
    console.log('setPath end 2', xxx);
  }
